...
const user = {
    ...
    summary: "Full stack developer with 3 years of experience in web development. Passionate about building scalable applications and learning new technologies."
  };
...
router.get("/get-videos", async (req, res) => {
  try {
    ...
    const coursesPromises = searchQueries.map(query => getYouTubeCourses(query));
